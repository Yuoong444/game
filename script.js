...
// v58 골드 수급 개선: 초반 클릭 보상과 등급 성장 체감을 상향
const gradeClickMultiplier = { E: 1.0, D: 1.28, C: 1.68, B: 2.25, A: 3.05, S: 4.35, SS: 6.25, SSS: 9.20 };
const gradeGoldBaseBonus = { E: 0, D: 60, C: 150, B: 310, A: 620, S: 1150, SS: 2100, SSS: 4200 };
const gradeGoldLevelBonus = { E: 18, D: 25, C: 36, B: 52, A: 76, S: 112, SS: 165, SSS: 250 };
...
function getSuccessRate() {
  ...
  return Math.min(96, base + getOptionBonus("rate") + getWeaponTrait().success);
}
...
$("enhanceBtn").onclick = () => {
  ...
  if (success) {
    ...
    enhanceCost = clampEnhanceCost(enhanceCost * 1.16 + 50);
    addGrowthExp(2);
    tryAddRandomOption();
    animateWand("success");
  } else {
    ...
    enhanceCost = clampEnhanceCost(enhanceCost * 1.04 + 20);
...
$("autoBtn").onclick = () => {
  ...
  gold -= autoCost;
  stone += 4;
  autoCost = Math.floor(autoCost * 1.38);
