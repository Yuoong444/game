...
const SAVE_KEY = "magicWandRpgSaveV56";
const LEGACY_SAVE_KEYS = ["magicWandRpgSaveV55", "magicWandRpgSaveV54", "magicWandRpgSaveV53", "magicWandRpgSaveV52", "magicWandRpgSaveV51", "magicWandRpgSaveV50", "magicWandRpgSaveV49", "magicWandRpgSaveV48", "magicWandRpgSaveV47", "magicWandRpgSaveV46", "magicWandRpgSaveV45", "magicWandRpgSaveV44", "magicWandRpgSaveV35", "magicWandFixedGamePlus", "magicWandFixedGame"];
...
function getGradeClickMultiplier() {
  ...
  if (wand.grade === "SSS") {
    return sssLevelMultiplier.reduce((value, tier) => level >= tier.level ? tier.multiplier : value, gradeClickMultiplier.SSS);
  }
