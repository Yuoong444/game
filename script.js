...
function gradeImagePath(grade, element = "normal", targetLevel = level) {
  ...
  return "img/wand/by_attribute_stage/wand_" + attr + "_lv" + stage + ".png?v=61";
}
...
function update(forceFullRender = false) {
  ...
  setText("assetInfo", normalizeAssetElement(wand.element).toUpperCase() + " · 에셋 LV" + assetStageFor(wand.grade, level));
