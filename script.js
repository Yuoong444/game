...
const SAVE_KEY = "magicWandRpgSaveV49";
const LEGACY_SAVE_KEYS = ["magicWandRpgSaveV48", "magicWandRpgSaveV47", "magicWandRpgSaveV46", "magicWandRpgSaveV45", "magicWandRpgSaveV44", "magicWandRpgSaveV35", "magicWandFixedGamePlus", "magicWandFixedGame"];
...
if (panelCloseBtn) panelCloseBtn.addEventListener("click", (e) => {
  e.stopPropagation();
  closeMobilePanel();
});

// v39: 모바일 우측 메뉴를 메뉴 버튼 1개로 제어
...
document.addEventListener("click", (e) => {
  ...
  if (rp && !rp.contains(e.target)) document.body.classList.remove("mobile-menu-open");
});
